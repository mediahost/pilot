...
//			\Nette\Framework::fixNamespace($loggerInterface);
	...
	public function __construct($filenameMask = NULL, $minimumLogLevel = NULL, $defaultLogLevel = NULL, $logDir = NULL, $granularity = 0)
	{
		...
		if ($minimumLogLevel === NULL)
			$minimumLogLevel = \Nette\Environment::isProduction() ? ILogger::INFO : ILogger::DEBUG;
	...
	public function getFile()
	{
		if ($this->file === NULL) {
			...
			$this->file = ($path = \Nette\Environment::expand($this->logDir))
