...
//        });
    ...
    var handleInputMasks = function() {
        ...
        $.extend($.inputmask.defaults.aliases, {
            'phone': {
                url: basePath + "/assets/plugins/jquery-inputmask/phone-codes/phone-codes.json",
                mask: function(opts) {
                    opts.definitions = {
                        'p': {
                            validator: function() {
...
//        }); //specifying fn & options
        ...
        $(".mask_currency_eur").inputmask('€ 999.999.999,99', {
            numericInput: true
        }); //123456  =>  € ___.__1.234,56
        $(".mask_currency_eur2").inputmask('€ 999,999,999.99', {
            numericInput: true,
            rightAlignNumerics: false,
            greedy: false
        }); //123456  =>  € ___.__1.234,56
        $(".mask_currency_czk").inputmask('999 999 999,99 Kč', {
            numericInput: true
        }); //123456  =>  ___.__1 234,56 Kč
