...
//		this.fallbackLinkText = "Nejdou vám soubory nahrát? Klikněte zde."; 
		this.fallbackLinkText = "Nejdú ti nahrať súbory? Klikni tu."; 
		...
		this.switchUI = function(ui) {
			var currentUI = this.activeUI||this.fallbacks[0];
            if(eval(currentUI.destruct,this) == true &&eval(ui.init,this)==true) {
//            if (new Function(currentUI.destruct).call(this) == true 
//                && new Function(ui.init).call(this) == true
//            ) {
		...
		this.switchUI(this.fallbacks[0]);
