...
links.locales['cs'] = {
    ...
    'MONTHS_SHORT': new Array("Led", "Úno", "Bře", "Dub", "Kvě", "Čer", "Čvc", "Srp", "Zář", "Říj", "Lis", "Pro"),
    'DAYS': new Array("Neděle", "Pondělí", "Úterý", "Středa", "Čtvrtek", "Pátek", "Sobota"),
    'DAYS_SHORT': new Array("Ne", "Po", "Út", "St", "Čt", "Pá", "So"),
    'ZOOM_IN': "Přiblížit",
    'ZOOM_OUT': "Oddálit",
    'MOVE_LEFT': "Posun doleva",
    'MOVE_RIGHT': "Posun doprava",
    'NEW': "Nová",
    'CREATE_NEW_EVENT': "Vytvořit novou událost"
};
links.locales['cs_CZ'] = links.locales['cs'];
